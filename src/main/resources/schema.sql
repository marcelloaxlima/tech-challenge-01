...
CREATE TABLE IF NOT EXISTS pedidos (
    ...
    ultima_modificacao  DATETIME(6) NOT NULL,
    valor               DECIMAL(10,2),
    provedor            VARCHAR(30)           NULL,
    metodo              VARCHAR(30)           NULL,
    transaction_code    VARCHAR(255)          NULL,
    transaction_time    datetime              NULL,
    pagamento_status    VARCHAR(30)           NULL,
    PRIMARY KEY (id)
) ENGINE=InnoDB;
...
ALTER TABLE pedidos ADD CONSTRAINT FK_PEDIDOS_ON_COMBO FOREIGN KEY (combo_id) REFERENCES combos (id);
